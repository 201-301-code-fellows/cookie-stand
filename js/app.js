...
/* Array of strings to be displayed beside the data each hour */
const timeOpenArray = [
  'Time:',
  '6am:',
  '7am:',
...
totalTool(); // run the reset tool to set defaults to 0s
function totalTool() {
  const tfoot = document.querySelector('tfoot'); // update the total array to only contain 0s
  // remove extra strings from the totals array so when new cities added, they will generate their own strings
  if (tfoot) {
...
/* Display a flash message when creating new sites */
...
/* Generate heading for the table */
...
/* envocate all rendering and data building functions */
